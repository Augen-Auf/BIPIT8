<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="БИПиТ8.WebForm1" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="IdC" DataSourceID="SqlDataSource" Width="570px" CellPadding="4" ForeColor="#333333" GridLines="None" style="margin-top: 13px">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Phone" DataFormatString="{0:#(###)###-##-##}" HeaderText="Phone" SortExpression="Phone" />
            </Columns>
