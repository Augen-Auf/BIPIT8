<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="БИПиТ8.WebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="IdS" DataSourceID="SqlDataSource" Width="550px" CellPadding="4" ForeColor="#333333" GridLines="None" style="margin-top: 13px">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Price" DataFormatString="{0:N0}" HeaderText="Price" SortExpression="Price" />
        </Columns>
